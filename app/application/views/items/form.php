...
$(document).ready(function()
{
	...
	const NON_STOCKED_CATEGORIES = ['User Support','Recycling Fees','CBV Membership', 'Used Equipment', 'New Equipment', 'Ebay Sales','Cost of Sharing Services', 'Donation', 'Membership'];
