...
Uncomment to enable auto http detection, required to have it force set due to nginx reverse proxy

 */

$whitelist = array('127.0.0.1', "::1"); // if on localhost then don't redirect to https
...
|
 */
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : 'f7eb4ad10b75ba658dc0665fad84f6cb0c90cd60bc5720e14aef6ee5b2cd4cc6';
