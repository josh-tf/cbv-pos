...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dist/opensourcepos.min.css?rel=d283245aa5" />
	<!-- end mincss template tags -->
	<!-- start minjs template tags -->
	<script type="text/javascript" src="dist/opensourcepos.min.js?rel=ce03dc6792"></script>
		...
		<div class="topbar">
			<div class="container">
				...
				<div class="navbar-center" style="text-align:center">
					<strong>
						<?php echo $this->config->item('company'); ?></strong>
				</div>
			</div>
		</div>
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="<?php echo $module->module_id == $this->uri->segment(1) ? 'active' : ''; ?>">
							<a href="<?php echo base_url() . $module->module_id; ?>" title="
